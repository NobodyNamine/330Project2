...
// checkbox event handlers
  ...
  const bassChk = document.querySelector("#bassCB");
  const trebleChk = document.querySelector("#trebleCB");
    
/*document.querySelector("#v").visibility = hidden;*/
    
    
videoChk.onchange = e =>{
    if (e.target.checked == true){
        drawParams.showVideo = true;
    }
    else{
        drawParams.showVideo = false;
    }
}
...
bassChk.onchange = e =>{
    if (e.target.checked == true){
        drawParams.showBass = true;
    }
    else{
        drawParams.showBass = false;
    }
}
trebleChk.onchange = e=>{
    if (e.target.checked == true){
        drawParams.showTreble = true;
    }
    else{
        drawParams.showTreble = false;
    }
}
